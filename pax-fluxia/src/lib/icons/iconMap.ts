...
import {
  ...
  ChevronDown as LuChevDown, ChevronsRight as LuChevsRight, X as LuX, Check as LuCheck,
...
import {
  ...
  CaretDoubleRight as PhCaretDbl, X as PhX, Check as PhCheck, MagnifyingGlass as PhSearch,
  Palette as PhPalette, Books as PhBooks, Plus as PhPlus, Export as PhExport,
  DownloadSimple as PhDownload, UploadSimple as PhUpload, ArrowCounterClockwise as PhRotate,
...
import {
  ...
  IconX, IconCheck, IconSearch, IconPalette, IconBooks, IconPlus, IconUpload,
...
export const ICON_MAP: Record<string, IconTriple> = {
  ...
  // Affirmative mark — selected state on pickers and tiles.
  check: t(LuCheck, PhCheck, IconCheck),
  ...
  // Export produces a downloadable file; import takes a file up from your disk.
  export: t(LuDownload, PhExport, IconDownload),
  import: t(LuUpload, PhUpload, IconUpload),
