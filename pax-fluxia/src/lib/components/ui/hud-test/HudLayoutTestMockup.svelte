<script lang="ts">
  ...
  const utilityModes: Array<{ id: UtilityMode; label: string; icon: string }> = [
    { id: "overview", label: "Overview", icon: "leaderboard" },
    { id: "settings", label: "Settings", icon: "tune" },
    { id: "overlays", label: "Overlays", icon: "map-options" },
    { id: "legend", label: "Legend", icon: "help" },
  ];
  ...
  <div class="hud-grid">
    ...
    <main class="map-hud" aria-label="Map widgets">
      <div class="map-control hud-panel">
        ...
        <button type="button" class="icon-btn"><HudIcon name="fit" /></button>
      </div>
      {#if legendOpen}
        <div class="floating-legend hud-panel">
          ...
          <span>Territory, lanes, orders, and labels stay map-relative.</span>
        </div>
      {/if}
      {#if confirmOpen}
...
<style>
  ...
  .hud-panel { border: 1px solid rgba(132, 190, 255, .28); border-radius: 16px; background: rgba(4, 10, 22, .78); box-shadow: 0 24px 80px rgba(0, 0, 0, .38), inset 0 0 0 1px rgba(255, 255, 255, .035); backdrop-filter: blur(18px); pointer-events: auto; }
  ...
  .icon-btn { justify-content: center; width: 36px; height: 36px; border: 1px solid rgba(132, 190, 255, .26); border-radius: 11px; background: rgba(10, 18, 34, .8); color: #e0f2fe; cursor: pointer; }
  ...
  .mode-tabs button, .command-modes button, .speed-row button { justify-content: center; gap: 6px; border: 1px solid rgba(132, 190, 255, .2); border-radius: 11px; background: rgba(0, 0, 0, .18); color: rgba(226, 232, 240, .82); padding: 9px 10px; font: inherit; cursor: pointer; }
  ...
  .mini-card { display: grid; gap: 8px; padding: 12px; border: 1px solid rgba(132, 190, 255, .17); border-radius: 13px; background: rgba(0, 0, 0, .22); }
  ...
  .floating-legend { position: absolute; top: 0; right: 0; width: min(280px, 42vw); padding-bottom: 12px; }
  .floating-legend > span { display: block; padding: 0 12px; color: rgba(203, 213, 225, .82); }
  ...
  .confirm button, .mini-card button { border: 1px solid rgba(255, 200, 107, .34); border-radius: 10px; background: rgba(255, 200, 107, .12); color: #ffedd5; padding: 8px 10px; font: inherit; cursor: pointer; }
  ...
  .quick-stars button { gap: 8px; min-width: 0; border: 1px solid rgba(132, 190, 255, .18); border-radius: 12px; background: rgba(0, 0, 0, .2); color: #e2e8f0; padding: 8px 10px; cursor: pointer; }
