...
export const PANEL_CONFIG_MAP: PanelConfigMapping[] = [
    ...
    { panelKey: 'territoryFillTransition', configKey: 'TERRITORY_FILL_TRANSITION_MODE' },
    { panelKey: 'territoryBorderTransition', configKey: 'TERRITORY_BORDER_TRANSITION_MODE' },
