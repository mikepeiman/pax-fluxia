...
export const PANEL_CONFIG_MAP: PanelConfigMapping[] = [
    ...
    { configKey: 'PVV4_PROGRESS_PROFILE' },
    { configKey: 'PVV4_PROGRESS_BLEND' },
    { configKey: 'PVV4_STABLE_ANCHOR_EPS' },
    { configKey: 'PVV4_CHANGE_SPAN_EPS' },
    { configKey: 'PVV4_CHANGE_SPAN_PAD_POINTS' },
