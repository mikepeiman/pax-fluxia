...
export const PANEL_CONFIG_MAP: PanelConfigMapping[] = [
    ...
    { panelKey: 'metaballBorderWidth', configKey: 'TERRITORY_SURFACE_BORDER_WIDTH' },
    { panelKey: 'metaballBorderAlpha', configKey: 'TERRITORY_SURFACE_BORDER_ALPHA' },
    ...
    { panelKey: 'metaballFillEnabled', configKey: 'TERRITORY_SURFACE_FILL_ENABLED' },
    { panelKey: 'metaballBorderEnabled', configKey: 'TERRITORY_SURFACE_BORDER_ENABLED' },
