...
<div class="var-desc">
    Topology constraints are owned once, in <strong>Topology Rules</strong>. This source module now only chooses which compiled geometry perimeter-field samples from.
</div>
