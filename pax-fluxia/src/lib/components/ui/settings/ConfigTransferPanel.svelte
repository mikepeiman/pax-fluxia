...
<!-- "Config Presets" removed 2026-08-12: named snapshots of the whole config
     are what the Theme Library already is, and once this panel moved into the
     Themes category the two sat side by side. Saved presets are migrated into
     the library by themeStore.migrateFullConfigPresets, not discarded. -->
