...
const SCOPE_LABEL_META: LabelScopeMap = {
  ...
  'Star Bias': { key: 'TERRITORY_MSR_STAR_BIAS' },
        ...
        'Grid Gradient Backend': { key: 'GRID_GRADIENT_DRAW_BACKEND' },
        'Shader Neighbor Mode': { key: 'GRID_GRADIENT_SHADER_NEIGHBOR_MODE' },
        'Shader Mark Softness': { key: 'GRID_GRADIENT_SHADER_MARK_SOFTNESS' },
        'Shader Edge Softness': { key: 'GRID_GRADIENT_SHADER_EDGE_SOFTNESS_PX' },
        'Shader Noise': { key: 'GRID_GRADIENT_SHADER_NOISE_STRENGTH' },
        'Shader Pulse': { key: 'GRID_GRADIENT_SHADER_PULSE_STRENGTH' },
        'Shader Pulse Speed': { key: 'GRID_GRADIENT_SHADER_PULSE_SPEED' },
        'Transition Scale Min': { key: 'GRID_GRADIENT_SHADER_TRANSITION_SCALE_MIN' },
        ...
        'Shader Color Power': { key: 'GRID_GRADIENT_SHADER_COLOR_MIX_POWER' },
        'Border Blend Range': { key: 'GRID_GRADIENT_BORDER_BLEND_RANGE_PX' },
        'Border Blend Strength': { key: 'GRID_GRADIENT_BORDER_BLEND_STRENGTH' },
