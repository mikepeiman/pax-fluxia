...
export const SETTINGS_SECTIONS: readonly SettingsSectionDefinition[] = [
    ...
    },
    {
        ...
        scope: "ships",
        subsections: [
            { id: "star-scale", label: "Star System Scale", icon: "fit" },
            { id: "ship-size", label: "Ship Size & Shape", icon: "travel" },
            { id: "halos", label: "Star Halos", icon: "effects" },
            { id: "orbit", label: "Orbit Layout", icon: "atlas-compass" },
            { id: "star-shape", label: "Star Shape", icon: "fleet-star" },
            { id: "ownership-ring", label: "Ownership Ring", icon: "flag" },
            { id: "labels", label: "Star Labels", icon: "font" },
            { id: "arrows", label: "Order Arrows", icon: "orders" },
            { id: "damaged", label: "Damaged Ships", icon: "shield" },
            { id: "interaction", label: "Interaction", icon: "focus" },
            { id: "density", label: "Density Coloring", icon: "leaderboard" },
            { id: "glow", label: "Star Glow", icon: "frontier-fx" },
        ],
    },
    {
        id: "audio",
