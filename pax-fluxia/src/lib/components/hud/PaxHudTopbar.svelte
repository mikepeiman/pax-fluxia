<script lang="ts">
  ...
  import type { PlayerStandingViewModel, SelectedStarViewModel } from "$lib/components/game-hud/types";
...
<header class="pf-hud-topbar">
  <div class="pf-hud-topbar__brand">
    <PaxHudIconButton icon="menu" title="Main menu" onclick={onMenuClick} class="pf-hud-icon-button" />
