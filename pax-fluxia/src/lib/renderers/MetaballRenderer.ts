...
function buildFingerprint(
    ...
    fp += `:${GAME_CONFIG.METABALL_BLEND_SHARPNESS}:${GAME_CONFIG.TERRITORY_SURFACE_ALPHA}`;
    ...
    fp += `:${GAME_CONFIG.TERRITORY_SURFACE_BORDER_WIDTH}:${GAME_CONFIG.TERRITORY_SURFACE_BORDER_ALPHA}`;
    fp += `:${GAME_CONFIG.TERRITORY_SURFACE_SATURATION}:${GAME_CONFIG.TERRITORY_SURFACE_LIGHTNESS}`;
    fp += `:${GAME_CONFIG.TERRITORY_SURFACE_BORDER_SATURATION}:${GAME_CONFIG.TERRITORY_SURFACE_BORDER_LIGHTNESS}`;
...
function renderMetaballImpl(
    ...
    const alpha = GAME_CONFIG.TERRITORY_SURFACE_ALPHA ?? 0.5;
    ...
    const borderWidth = GAME_CONFIG.TERRITORY_SURFACE_BORDER_WIDTH ?? 1.5;
    const borderAlpha = GAME_CONFIG.TERRITORY_SURFACE_BORDER_ALPHA ?? 0.6;
    const fillSatMult = GAME_CONFIG.TERRITORY_SURFACE_SATURATION ?? 1.0;
    const fillLightMult = GAME_CONFIG.TERRITORY_SURFACE_LIGHTNESS ?? 1.0;
    const fillFollowsGeom = GAME_CONFIG.METABALL_FILL_FOLLOWS_GEOM ?? false;
    const borderSatMult = GAME_CONFIG.TERRITORY_SURFACE_BORDER_SATURATION ?? 1.0;
    const borderLightMult = GAME_CONFIG.TERRITORY_SURFACE_BORDER_LIGHTNESS ?? 1.0;
