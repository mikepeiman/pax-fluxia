...
export const territoryConfigDefaults = {
    ...
    PVV4_PROGRESS_PROFILE: 'smoothstep' as const,
    PVV4_PROGRESS_BLEND: 0.4,
    PVV4_STABLE_ANCHOR_EPS: 2,
    PVV4_CHANGE_SPAN_EPS: 2,
    PVV4_CHANGE_SPAN_PAD_POINTS: 0,
    ...
    TERRITORY_GEOMETRY_MODE: 'canonical_power_voronoi' as const,
