...
export const BACKGROUND_MODE_CATALOG: readonly BackgroundModeDefinition[] = [
    ...
    },
    {
        ...
        modeTunables: [
            { key: 'density', label: 'Density', min: 0, max: 12, step: 0.1, defaultValue: 0.45 },
            { key: 'driftSpeed', label: 'Drift', min: 0, max: 12, step: 0.1, defaultValue: 0.65 },
            { key: 'contrast', label: 'Contrast', min: 0, max: 8, step: 0.1, defaultValue: 0.35 },
            { key: 'parallaxDepth', label: 'Parallax', min: 0, max: 12, step: 0.1, defaultValue: 0.25 },
        ],
        defaultsBySurface: surfaceDefaults(
            {
                intensity: 0.48,
    ...
    },
    {
        ...
        sharedTunables: SHARED_TUNABLES,
        modeTunables: [
            { key: 'bandCount', label: 'Bands', min: 1, max: 24, step: 1, defaultValue: 3 },
            { key: 'sweepAngle', label: 'Angle', min: -180, max: 180, step: 5, defaultValue: -20 },
            { key: 'sweepWidth', label: 'Width', min: 0.05, max: 4, step: 0.05, defaultValue: 0.3 },
            { key: 'sweepSpeed', label: 'Sweep Speed', min: 0, max: 12, step: 0.1, defaultValue: 0.55 },
        ],
        defaultsBySurface: surfaceDefaults(
            {
                intensity: 0.38,
    ...
    },
    {
        ...
        sharedTunables: SHARED_TUNABLES,
        modeTunables: [
            { key: 'mistDensity', label: 'Mist Density', min: 0, max: 12, step: 0.1, defaultValue: 0.5 },
            { key: 'curlAmount', label: 'Curl', min: 0, max: 8, step: 0.1, defaultValue: 0.4 },
            { key: 'glintRate', label: 'Glint Rate', min: 0, max: 12, step: 0.1, defaultValue: 0.2 },
            { key: 'falloff', label: 'Falloff', min: 0, max: 8, step: 0.1, defaultValue: 0.55 },
        ],
        defaultsBySurface: surfaceDefaults(
            {
                intensity: 0.44,
    ...
    },
    {
        ...
        sharedTunables: SHARED_TUNABLES,
        modeTunables: [
            { key: 'particleDensity', label: 'Particle Density', min: 0, max: 12, step: 0.1, defaultValue: 0.32 },
            { key: 'sizeRange', label: 'Size Range', min: 0.1, max: 8, step: 0.1, defaultValue: 0.42 },
            { key: 'twinkleRate', label: 'Twinkle', min: 0, max: 12, step: 0.1, defaultValue: 0.35 },
            { key: 'depthSpread', label: 'Depth Spread', min: 0, max: 8, step: 0.1, defaultValue: 0.5 },
        ],
        defaultsBySurface: surfaceDefaults({}, {
            intensity: 0.46,
            animationSpeed: 0.9,
    ...
    },
    {
        ...
        sharedTunables: SHARED_TUNABLES,
        modeTunables: [
            { key: 'lineDensity', label: 'Line Density', min: 0, max: 12, step: 0.1, defaultValue: 0.35 },
            { key: 'flowSpeed', label: 'Flow Speed', min: 0, max: 12, step: 0.1, defaultValue: 0.7 },
            { key: 'warpAmount', label: 'Warp', min: 0, max: 8, step: 0.1, defaultValue: 0.35 },
            { key: 'lineThickness', label: 'Thickness', min: 0.1, max: 8, step: 0.1, defaultValue: 0.28 },
        ],
        defaultsBySurface: surfaceDefaults({}, {
            intensity: 0.44,
            animationSpeed: 0.85,
    ...
    },
    {
        ...
        sharedTunables: SHARED_TUNABLES,
        modeTunables: [
            { key: 'emberDensity', label: 'Ember Density', min: 0, max: 12, step: 0.1, defaultValue: 0.3 },
            { key: 'riseSpeed', label: 'Rise Speed', min: 0, max: 12, step: 0.1, defaultValue: 0.85 },
            { key: 'heatDistortion', label: 'Heat Distortion', min: 0, max: 8, step: 0.1, defaultValue: 0.25 },
            { key: 'sparkLifetime', label: 'Spark Lifetime', min: 0.1, max: 8, step: 0.1, defaultValue: 0.45 },
        ],
        defaultsBySurface: surfaceDefaults({}, {
            intensity: 0.5,
            animationSpeed: 0.95,
    ...
    },
    {
        ...
        sharedTunables: SHARED_TUNABLES,
        modeTunables: [
            { key: 'flakeDensity', label: 'Flake Density', min: 0, max: 12, step: 0.1, defaultValue: 0.28 },
            { key: 'glintFrequency', label: 'Glint Frequency', min: 0, max: 12, step: 0.1, defaultValue: 0.3 },
            { key: 'crystalSharpness', label: 'Crystal Sharpness', min: 0, max: 8, step: 0.1, defaultValue: 0.45 },
            { key: 'pulseSoftness', label: 'Pulse Softness', min: 0, max: 8, step: 0.1, defaultValue: 0.55 },
        ],
        defaultsBySurface: surfaceDefaults({}, {
            intensity: 0.42,
            animationSpeed: 0.78,
    ...
    },
    {
        ...
        sharedTunables: SHARED_TUNABLES,
        modeTunables: [
            { key: 'chargeDensity', label: 'Charge Density', min: 0, max: 12, step: 0.1, defaultValue: 0.35 },
            { key: 'arcFrequency', label: 'Arc Frequency', min: 0, max: 12, step: 0.1, defaultValue: 0.3 },
            { key: 'crawlSpeed', label: 'Crawl Speed', min: 0, max: 12, step: 0.1, defaultValue: 0.8 },
            { key: 'frontierWidth', label: 'Frontier Width', min: 0.1, max: 8, step: 0.1, defaultValue: 0.35 },
        ],
        defaultsBySurface: surfaceDefaults({}, {
            intensity: 0.48,
            animationSpeed: 1,
