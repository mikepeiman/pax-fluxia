Geometry should output a canonical boundary representation, not just polygons. Each territory frontier is a loop of identity-bearing boundary vertices and directed boundary edges. Each edge knows:
...
whether it is owner-owner or owner-world,

its geometric definition to the next vertex, such as line, arc, or smoothed curve parameters.
